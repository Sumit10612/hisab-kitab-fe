...
export namespace ExpenseSelector {
	export const selectAllExpenses: MemoizedSelector<State, Expense[]> = createSelector(
		expenseAdapterSelector.selectAll,
		expenses => expenses
	);

	export const selectExpense: (id: string) => MemoizedSelector<State, Expense | undefined> = (id) => createSelector(
